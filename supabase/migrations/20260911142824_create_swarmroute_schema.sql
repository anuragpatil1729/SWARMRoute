...
CREATE TABLE IF NOT EXISTS public.delivery_partners (
    ...
    max_weight NUMERIC(6,1) DEFAULT 100.0,
    fuel_level NUMERIC(5,1) DEFAULT 100.0,
    speed_kmh NUMERIC(5,1) DEFAULT 0.0,
    location_x NUMERIC(6,2) DEFAULT 40.0,
    location_y NUMERIC(6,2) DEFAULT 50.0,
...
CREATE TABLE IF NOT EXISTS public.orders (
    ...
    area TEXT,
    city TEXT DEFAULT 'Bengaluru',
    demand_weight NUMERIC(6,1) NOT NULL DEFAULT 10.0,
    priority TEXT DEFAULT 'NORMAL',
    deadline NUMERIC(6,1) DEFAULT 120.0,
...
CREATE TABLE IF NOT EXISTS public.task_allocations (
    ...
    allocated_by TEXT DEFAULT 'Company Manager (Admin)',
